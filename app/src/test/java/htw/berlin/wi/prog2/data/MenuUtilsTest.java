...
class MenuUtilsTest {
    ...
    private final Ingredient champignons = builder.setName("Gurken").setPrice("0.01").setCals(1000).build(TOPPING);
    private final Ingredient mozzarella = builder.setName("Cheddar-Käse").setPrice("0.02").setCals(2000).build(TOPPING);
    private final Ingredient schinken = builder.setName("Rindfleisch").setPrice("0.03").setCals(3000).build(PROTEIN);
